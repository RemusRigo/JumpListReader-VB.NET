...
Module AppID
   ...
   ' Jump List Database: AppID to Application Name mapping
   ' Case-insensitive: some keys below are not upper-cased, and callers pass raw IDs.
   Private ReadOnly JLDB As New Dictionary(Of String, String)(StringComparer.OrdinalIgnoreCase) From
   {
      {"0006F647F9488D7A", "AIM"},
      {"00098B0EF1C84088", "fulDC"},
      {"01B29F0DC90366BB", "AIM"},
      {"03D877EC11607FE4", "Thunderbird"},
      {"044A50E6C87BC012", "Classic FTP Plus"},
      ...
      {"122C907C4dC5911F", "Mozilla Firefox"},
      {"12DC1EA8E34B5A6", "Microsoft Paint"},
      {"134620458666CCB0", "TeraCopy"},
      ...
      {"1461132E553E2E6C", "Firefox"},
      {"14A48FBE3D43239A", "Windows System Information"},
      {"14A989D191548BBC", "Cyberlink PowerDVD"},
      ...
      {"174C2C811C286C58", "InfraRecorder"},
      {"177AEB41DEB606AE", "Adobe Photoshop CS6"},
      {"17D3EB086439F0D7", "TrueCrypt"},
      {"18434D518C3A61EB", "Minitab"},
      {"186B5CCADA1D986B", "NewsGrabber"},
      {"188F5EC9D11DED56", "Microsoft Edge"},
      {"18AE7CDA503D746E", "Advanced System Optimizer"},
      {"18FA158A64C9508A", "Mozilla Firefox"},
      {"19CCEE0274976DA8", "mIRC"},
      {"19E6043495A5B4DA", "Edit Pad Pro"},
      {"1A60B1067913516A", "Psi"},
      {"1A89D1BEFE8E90E3", "Adobe Acrobat Distiller"},
      ...
      {"1CFFBE973A437C74", "DSPlayer"},
      {"1D12F965B876DC87", "Snagit"},
      {"1DA3C90A72BF5527", "Safari"},
      {"1EB796D87C32EFF9", "Firefox"},
      {"1F1F846F76251EA8", "Microsoft Office Desktop Word 16xxx"},
      {"20513CDF29D09C0E", "Hex Editor Neo"},
      {"20EF367747C22564", "Bullet Proof FTP"},
      {"21982DADE69F78D8", "Opera Browser"},
      {"223BF0F360C6FEA5", "I2P 0.8.8 (restartable)"},
      {"226400522157FE8B", "FileZilla Server"},
      {"22C4D315E96389E0", "FastCopy"},
      ...
      {"2C9C7B1C0D1C0E0B", "Microsoft Edge"},
      ...
      {"31B6EBFFF794EF0D", "Opera Browser"},
      ...
      {"3D6BE802D0A1F86A", "Mozilla Firefox"},
      ...
      {"58BEE77C49899591", "Apple iTunes"},
      {"590AEE7BDD69B59B", "Windows Powershell"},
      {"59E86071B87AC1C3", "CuteFTP"},
      {"59F56184C796CFD4", "ACDSee Photo Manager"},
      ...
      {"8AC3B9B6C0D1C0E0", "Google Chrome"},
      {"8B87640A40EC9FC", "Snagit 2020"},
      {"8BCE06A9E923E1F9", "Slack 4.10.3"},
      {"8BD5C6433CA967E9", "ACDSee Photo Manager"},
      ...
      {"9B9CDC69C1C24E2B", "Microsoft Word / Notepad 64-bit"},
      ...
      {"B77EF7F3FC946302", "Pale Moon Browser"},
      ...
      {"C31B3D36438B5E2C", "Visual Studio Enterprise"},
      ...
      {"D788E8BC973B89E9", "PKWARE PKZIP for Windows"},
      {"D7D647C92CD5D1E6", "uTalk"},
      {"D7DB75DB9CDD7C5D", "Xnews"},
      {"D8081F151F4BD8A5", "CuteFTP"},
      {"D838AAC097ABECE7", "ACDSee Photo Manager"},
      {"D8671C1ED93C75C8", "Tor Browser 5.5.2"},
      {"D93F411851D7C929", "Windows Powershell"},
      ...
      {"DE48A32EDCBE79E4", "Adobe Acrobat Reader DC"},
      ...
      {"EAB25958DBDDBAA4", "Binary News Reaper 2"},
   ...
   ' Define the function
   Public Function GetAppByID(appID As String) As String
      If String.IsNullOrEmpty(appID) Then Return "App not found"

      Dim result As String = ""
      If JLDB.TryGetValue(appID, result) Then
         Return result
      Else
